...
function Settings() {
    ...
    const fetchContacts = async () => {
      try {
          const response = await axios.get(`https://i-sole-backend.com/get_all_contacts/${patientUsername}`);
  ...
  const handleSubmit = async (event) => {
      ...
      try {
        const response = await axios.post('https://i-sole-backend.com/add_contact', {
      ...
      try {
        const url = 'https://i-sole-backend.com/make_call';
    ...
    const removeContact = async (contactNameToRemove) => {
      try {
        ...
        await axios.post('https://i-sole-backend.com/delete_contact', {
